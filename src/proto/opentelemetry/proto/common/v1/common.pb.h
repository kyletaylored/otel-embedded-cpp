...
namespace nanopb {
template <>
struct MessageDescriptor<opentelemetry_proto_common_v1_AnyValue> {
    static PB_INLINE_CONSTEXPR const pb_size_t fields_array_length = 7;
    static inline const pb_msgdesc_t* fields() {
        return &opentelemetry_proto_common_v1_AnyValue_msg;
    }
...
template <>
struct MessageDescriptor<opentelemetry_proto_common_v1_ArrayValue> {
    static PB_INLINE_CONSTEXPR const pb_size_t fields_array_length = 1;
    static inline const pb_msgdesc_t* fields() {
        return &opentelemetry_proto_common_v1_ArrayValue_msg;
    }
    static inline bool has_msgid() {
        return false;
    }
...
template <>
struct MessageDescriptor<opentelemetry_proto_common_v1_KeyValueList> {
    static PB_INLINE_CONSTEXPR const pb_size_t fields_array_length = 1;
    static inline const pb_msgdesc_t* fields() {
        return &opentelemetry_proto_common_v1_KeyValueList_msg;
    }
    static inline bool has_msgid() {
        return false;
    }
...
template <>
struct MessageDescriptor<opentelemetry_proto_common_v1_KeyValue> {
    static PB_INLINE_CONSTEXPR const pb_size_t fields_array_length = 2;
    static inline const pb_msgdesc_t* fields() {
        return &opentelemetry_proto_common_v1_KeyValue_msg;
    }
    static inline bool has_msgid() {
        return false;
    }
...
template <>
struct MessageDescriptor<opentelemetry_proto_common_v1_InstrumentationScope> {
    static PB_INLINE_CONSTEXPR const pb_size_t fields_array_length = 4;
    static inline const pb_msgdesc_t* fields() {
        return &opentelemetry_proto_common_v1_InstrumentationScope_msg;
    }
    static inline bool has_msgid() {
        return false;
    }
...
template <>
struct MessageDescriptor<opentelemetry_proto_common_v1_EntityRef> {
    static PB_INLINE_CONSTEXPR const pb_size_t fields_array_length = 4;
    static inline const pb_msgdesc_t* fields() {
        return &opentelemetry_proto_common_v1_EntityRef_msg;
    }
    static inline bool has_msgid() {
        return false;
    }
